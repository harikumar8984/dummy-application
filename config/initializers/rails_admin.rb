...
RailsAdmin.config do |config|
  ...
  config.actions do
    ...
    show
    edit do
      only ['User','Course', 'CourseContent', 'Content', 'CourseCategory', 'MailTemplate', 'Subscription', 'DeviceDetail', 'SubscriptionPlan']
    end
    delete  do
      only ['User', 'Course', 'CourseContent', 'Content', 'CourseCategory', 'MailTemplate','Subscription',  'SubscriptionPlan']
    end
    show_in_app
